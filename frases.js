export const candidatos = [
  {
    ...
    frases: [
      ...
      '"Si yo tuviera un hijo no lo vendería, quizás de acá a 200 años se podría debatir"',
  ...
  },
  {
    ...
    frases: [
      '"Es todo o nada"',
      '"No podemos darnos el lujo de hacerlo a medias otra vez"',
  ...
  },
  {
    nombre: "Larreta",
    frases: [
      '"Vamos a hacer una reforma laboral"',
  ...
  },
  {
    nombre: "Solano",
    frases: [
      '"Si ganamos, nuestra primera medida es aumentar salarios y jubilaciones"',
      "“El dictador Morales quiere meter presos a todos los que estén en contra de su gobierno”",
      '"Para terminar con los planes sociales hay que generar trabajo genuino"',
